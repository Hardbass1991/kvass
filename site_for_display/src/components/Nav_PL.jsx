...
const Nav = () => {
  ...
  return (
    <Wrapper>
      ...
      <a href="#world" onClick={() => setActiveNav('#world')} className={activeNav === '#world' ? 'active' : ''}>World</a>
      <a href="#culture" onClick={() => setActiveNav('#culture')} className={activeNav === '#culture' ? 'active' : ''}>Culture</a>
    </Wrapper>
  )
}
