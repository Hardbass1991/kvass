...
# [(180, 'economy', 'https://www.epravda.com.ua', "article__title", "post__text", "post__title", 'post__time', 'post__text'),
# (145, 'politics', 'https://www.pravda.com.ua', "article_header", "post_text", 'post_title', 'post_time', 'post_text'), ]

n = 180  # n is the number of pages the section of every subject has
section = 'politics'
base_url = 'https://www.pravda.com.ua'
section_in_url = base_url + '/archives/date_'
